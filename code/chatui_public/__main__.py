...
def parse_args() -> argparse.Namespace:
    ...
    if cliargs.help_config:
        ...
        from chatui_public.configuration import AppConfig
...
if __name__ == "__main__":
    ...
    from chatui_public import api, chat_client, configuration, pages
    ...
    blocks.launch(server_name="0.0.0.0", server_port=8081, root_path=proxy_prefix)